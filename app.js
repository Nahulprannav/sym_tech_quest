(() => {
  ...
  function renderQuestionStation(station){
    ...
    if(!state || state.team!==profile.team){state={team:profile.team,ids:[],responses:{}};safeSet(stateKey,state);}
    const redraw=()=>{
